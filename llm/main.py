...
def main():
    ...
    if args.read_mlir is not None:
        ...
        if path.exists():
            ...
            # Check if running part1 or part2 specifically
            if args.part1:
                print("Running Part 1 (Steps 1a-1c)")
            elif args.part2:
                print("Running Part 2 (Steps 1d-OpenROAD)")
            else:
                print("Running complete optimization flow")
